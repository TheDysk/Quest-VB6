...
**31/01/2026 - V1.10** - Added text justification options for game text, moved game command line onto main form, and moved the "Show Debug Form" option onto the main form. Added QUIT command. 
